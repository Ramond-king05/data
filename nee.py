...
def authenticate(username, password):
    # This is a sample authentication function. You can replace it with your own logic.
...
def main():
    st.set_page_config(page_title="Scan The Bible", page_icon=":books:")
    ...
    if not state.login:
        ...
        show_main_page(state, menu, df, co, embeddings)


def show_login_page(state):
    st.title("Login")
...
def show_main_page(state, menu, df, co, embeddings):
